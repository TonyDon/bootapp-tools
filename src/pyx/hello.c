...
static PyObject *__pyx_kp_u_Hello_Cython;
 ...
 */
  ...
  __Pyx_INCREF(__pyx_kp_u_Hello_Cython);
  __Pyx_GIVEREF(__pyx_kp_u_Hello_Cython);
  PyTuple_SET_ITEM(__pyx_t_1, 0, __pyx_kp_u_Hello_Cython);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_u_Hello_Cython, __pyx_k_Hello_Cython, sizeof(__pyx_k_Hello_Cython), 0, 1, 0, 0},
